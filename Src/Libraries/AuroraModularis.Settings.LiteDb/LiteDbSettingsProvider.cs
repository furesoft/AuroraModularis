...
public class LiteDbSettingsProvider : IModuleSettingsProvider
{
    private LiteDatabase db;

    public LiteDbSettingsProvider(IBootstrapBuilder builder)
    {
        var dbpath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), builder.Configuration.ApplicationName, "modules.db");
